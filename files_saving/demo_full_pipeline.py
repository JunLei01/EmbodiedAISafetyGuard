...
#     object(medicine_bottle, medicine_bottle, [is_medication]).
...
# def demo_safety_report(result: SafetyReasoningResult):

    reasoner = DifferentiableSafetyReasoner()
    report = reasoner.get_safety_report(result)
